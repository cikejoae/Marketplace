    ...
    <div>
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFTs on HardHat</Text>
        </Row>
                ...
                return (
                  <Grid xs={3} key={id}>
                    ...
                    <Row key={id}wrap="wrap" justify="space-between" align="center">
                      ...
                      <Text  style={{ fontSize: '30px' }}>{nft.val} <img src='osis.png' alt={""} style={{ width: '60px', height: '25px', marginTop: '4px' }} /></Text>
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Available NFTs on HardHat</Text>
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
                ...
                <Card style={{ marginRight: '3px', boxShadow: '1px 1px 10px #ffffff' }} variant="bordered" key={i}>
                  ...
                  <Card.Footer css={{ justifyItems: "flex-start" }}>
                    <Row wrap="wrap" justify="space-between" align="center">
                      ...
                      <Text style={{ fontSize: '30px' }}>{nft.price}<img src='osis.png' alt={""} style={{ width: '60px', height: '25px', marginTop: '4px' }} /></Text>
        ...
        <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFTs on </Text><img src='ethereumlogo.png' alt={""} style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest NFTs on</Text><img src='ethereumlogo.png' alt={""} style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
        ...
        <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFTs on </Text><img src='bsc.png' alt={""} style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest NFTs on</Text><img src='bsc.png' alt={""} style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
        ...
        <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFTs on </Text><img src='polygonwhite.png' alt={""} style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest NFTs on</Text><img src='polygonwhite.png' alt={""} style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
