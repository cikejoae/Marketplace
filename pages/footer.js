...
<Container style={{borderTop:'1px solid #B22222'}}>
    ...
    <Spacer></Spacer>
                <Row gap={3}>
                    <Col>                            
                            <a href="/">
                            <Text h2 style={{color:"#fff",fontSmooth:"always",textShadow:"-0px 0px 3px #ffffff",fontFamily:"SF Pro Display",fontWeight:"700"}}>OSIS Marketplace</Text>
                            </a>
               ...
               <Row gap={3}>
                            <Text>©2022 OSIS Marketplace, All Rights Reserved.</Text>
                </Row>
    </Container>
    </Container>
    </div>
